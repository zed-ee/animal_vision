app_data = {
    ...
    messages: {
        et: {
            index: {
              button:'Alusta',
              h1: 'Kuidas näevad<br>maailma erinevad<br>elusorganismid?',
            },
            intro: {
              button:'Edasi',
            ...
            animals: {
              ...
              bee: 'Mesilane',
              dog: 'Koer',
              text: 'Vajuta sõrmega sind huvitavale elusorganismile <br>ja tõsta tahvelarvuti enda ette.',
            },
            vision: {
              fish: 'Kala (Latikas)',
              bird: 'Lind (Varblane)',
              snake: 'Uss (Harilik nastik)',
              bee: 'Mesilane (Kraini rass)',
              dog: 'Koer (Austraalia karjakoer)',
              back: 'Vali uus loom >',
              restart: 'Algusesse',
            },
             info_title: {
              fish: 'Kuidas kala näeb?',
              bird: 'Kuidas lind näeb?',
              snake: 'Kuidas uss näeb?',
              bee: 'Kuidas mesilane näeb?',
